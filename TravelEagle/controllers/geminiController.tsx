...
function buildUserPrompt(trip, numDays, interests): string{
  ...
  const pace = trip.pace ? trip.pace : 'Moderate: (5-6) Activities Per Day'
  const interestsString = trip.interests?.length ? trip.interests.join(", ") : "sightseeing, hiking, food, culture";
